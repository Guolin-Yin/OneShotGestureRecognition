...
def t_sne(data,n_components:int = 2,random_state = 0,perplexity:int = 6,n_iter:int = 5000):
	...
	visualize_scatter( data_2d = tsne_data, label_ids = domain_label, perplexity = perplexity, n_iter = n_iter)
if __name__ == '__main__':
	...
	t_sne( (data_val_1,signFiData_lab), perplexity = 10, n_iter = 2000 )